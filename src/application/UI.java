...
public class UI {
	...
	public static void imprimindoPartida(PartidaDeXadrez partidaDeXadrez, List<PecaDeXadrez> capturada) {
		imprimindoTabuleiro(partidaDeXadrez.getPecas());
		System.out.println();
	...
	public static void imprimindoTabuleiro(PecaDeXadrez[][] pecas) {
	...
	public static void imprimindoTabuleiro(PecaDeXadrez[][] pecas, boolean[][] movimentosPossiveis) {
		for (int i = 0; i < pecas.length; i++) {
			System.out.print((8 - i) + " ");
			for (int j = 0; j < pecas.length; j++) {
